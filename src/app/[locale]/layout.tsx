...
export async function generateMetadata({
  ...
  return {
    ...
    keywords:
      'portfolio, web development, design, Next.js, React, fullstack, automation, DevOps, Dari Dev',
    author: person.name,
      ...
      >
        ...
        >
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                description:
                  'Portfolio website showcasing web development and design work',
                sameAs: social
                  .filter(
                    (item) => item.link && !item.link.startsWith('mailto:')
                  )
                  .map((item) => item.link),
                founder: {
                  '@type': 'Person',
          ...
          <Script
            ...
            data-website-id={
              brand === '3s'
                ? process.env.NEXT_PUBLIC_UMAMI_WEBSITE_ID_3S ||
                  '5f68ac0a-5d37-461f-83d6-b070fac3cb71'
                : process.env.NEXT_PUBLIC_UMAMI_WEBSITE_ID_DARIDEV ||
                  'ea4f3991-4f85-4710-a9cc-fc4848110c56'
            }
            strategy='afterInteractive'
          />
